...
export class PersonlistComponent implements OnInit {
  ...
  constructor(private personSvc: PersonService, private authSvc: AuthService,
  ...
  loadAllPeople() {
    this.personSvc.getAllPerson(this.selectedContactId)
  ...
  onSelect(personId) {
    ...
    this.personSvc.getPerson(this.selectedPersonId)
    .subscribe(person => {
  ...
  savePerson() {
    this.personSvc.savePerson(this.selectedPerson)
    .subscribe( person => {
      this.loadAllPeople();
      this.selectedPerson = person;
    }, error => {
  ...
  deletePerson(personId) {
    this.personSvc.deletePerson(personId)
    .subscribe( result => {
      this.loadAllPeople();
  ...
  goBack() {
    this.router.navigate(['/contacts', this.selectedContactId], {relativeTo: this.route});
  }
}
